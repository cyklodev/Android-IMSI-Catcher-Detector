...
import com.cyklodev.AIMSICD.utils.CMDProcessor;
...
public class AIMSICDDbAdapter {
    ...
    private void dumpDB()  {
        ...
        //Bad coding?
        // CORRECT FOR PACKAGENAME // String aimdir = "/data/data/com.SecUpwN.AIMSICD/databases/";
        String aimdir = "/data/data/com.cyklodev.AIMSICD/databases/";
