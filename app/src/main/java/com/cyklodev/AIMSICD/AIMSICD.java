...
import com.cyklodev.AIMSICD.activities.BaseActivity;
import com.cyklodev.AIMSICD.activities.DebugLogs;
import com.cyklodev.AIMSICD.activities.MapViewerOsmDroid;
import com.cyklodev.AIMSICD.activities.PrefActivity;
import com.cyklodev.AIMSICD.adapters.AIMSICDDbAdapter;
import com.cyklodev.AIMSICD.adapters.DrawerMenuAdapter;
import com.cyklodev.AIMSICD.drawer.DrawerMenuActivityConfiguration;
import com.cyklodev.AIMSICD.drawer.DrawerMenuItem;
import com.cyklodev.AIMSICD.drawer.DrawerMenuSection;
import com.cyklodev.AIMSICD.drawer.NavDrawerItem;
import com.cyklodev.AIMSICD.fragments.AboutFragment;
import com.cyklodev.AIMSICD.fragments.AtCommandFragment;
import com.cyklodev.AIMSICD.fragments.DetailsContainerFragment;
import com.cyklodev.AIMSICD.service.AimsicdService;
import com.cyklodev.AIMSICD.service.CellTracker;
import com.cyklodev.AIMSICD.utils.AsyncResponse;
import com.cyklodev.AIMSICD.utils.Cell;
import com.cyklodev.AIMSICD.utils.GeoLocation;
import com.cyklodev.AIMSICD.utils.Helpers;
import com.cyklodev.AIMSICD.utils.Icon;
import com.cyklodev.AIMSICD.utils.LocationServices;
import com.cyklodev.AIMSICD.utils.RequestTask;
            ...
            final AlertDialog.Builder disclaimer = new AlertDialog.Builder(this)
                    ...
                    .setNegativeButton(R.string.text_disagree, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            prefsEditor.apply();
                            // CORRECT FOR PACKAGENAME //Uri packageUri = Uri.parse("package:com.SecUpwN.AIMSICD");
                            Uri packageUri = Uri.parse("package:com.cyklodev.AIMSICD");
    ...
    void selectItem(int position) {
        ...
        switch (selectedItem.getId()) {
            ...
            case 306:
                ...
                new RequestTask(mContext, com.cyklodev.AIMSICD.utils.RequestTask.DBE_UPLOAD_REQUEST).execute(""); // no string needed for csv based upload
                break;
        }
